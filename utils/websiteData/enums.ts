...
export enum sessionBtns {
	LOGIN = "Login",
	REGISTER = "Register",
	LOGOUT = "Logout",
}
export enum pageNotFound {
	HEADING = "Go back to the home page",
...
export enum btns {
	...
	DARK = "Dark",
	SYSTEM = "System",
	USER_FAVORITES = "Your Favorites",
	USER_TESTIMONIALS = "Your Testimonials",
}
...
export enum adminPageHeading {
	HOUSES = "houses list",
	CREATE_HOUSE = "create house",
	EDIT_HOUSE = "Edit Product",
	IMAGE_SLIDER = "Image Slider",
	USERS_LIST = "users list",
	TESTIMONIALS_LIST = "testimonial list",
}
